...
function simulateResponse() {
  ...
  setTimeout(() => {
    ...
    // Escalation fallback
      ...
      reply = `I couldn’t verify that yet. You can ask <a href="https://www.bing.com/search?q=${encodeURIComponent(input)}" target="_blank" style="color:#0056B3;">Copilot</a> or message us on <a href="https://wa.me/971501234567" target="_blank" style="color:#25D366;">WhatsApp</a>.`;
    }
